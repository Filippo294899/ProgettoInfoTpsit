...
import javazoom.basicplayer.advanced.BasicPlayer;
import javazoom.basicplayer.advanced.BasicPlayerException;

public class RiproduzioneMp3_3 { // basic player
    ...
    public synchronized static void stop() {
        if (playThread != null && playThread.isAlive()) {
            ...
            try {
                mediaPlayer.close();  // Ferma la riproduzione in corso
            } catch (BasicPlayerException e) {
                e.printStackTrace();
            }
            mutexPlay.release();
